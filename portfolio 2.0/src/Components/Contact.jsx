  ...
  return (
    ...
    >
      ...
      >
        <motion.h2
          variants={item}
          className="text-4xl sm:text-5xl font-bold mb-6 text-[#FFFFFF] pt-3"
        >
          Get In Touch
        </motion.h2>
        ...
        <motion.div
          variants={item}
          className="w-20 h-1 bg-[#C5A15B] mb-8 rounded-full"
        />

        <motion.div
          variants={item}
          className="bg-[#1C1C1C]/80 backdrop-blur-lg border border-[#2A2A2A] p-8 sm:p-10 rounded-2xl shadow-2xl max-w-2xl w-full text-center mx-4"
        >
          <motion.div
            variants={container}
          ...
          >
            ...
            >
              ...
              Whether it&apos;s about collaborating on projects, sharing ideas,
              or just chatting, feel free to reach out through my social media
              or email.
            </motion.p>
            ...
            <motion.div
              className="mt-8 pt-6 border-t border-[#2A2A2A] w-full"
              variants={item}
            >
